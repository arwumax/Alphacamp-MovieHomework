...
class allMovie {
    ...
    init() {
        ...
        movie4.movieDetail = "承接《復仇者聯盟2》，美國隊長帶領全新組合的復仇者聯盟，繼續保衛地球。但當一宗大型事故，令捲入其中的復仇者連累受害後，有政治壓力要求引入問責制，成立新的管治組織管理復仇者。由此導致復仇者分裂成為兩大陣營——由美國隊長帶領的一方竭力維持自主免受政府干預，另一方的鐵甲奇俠卻出人意表地靠攏政權。勢不兩立之際，一班復仇者還要面對新的邪惡強敵⋯⋯"
